...
#ifndef BITCOINNICKEL_INTERFACES_NODE_H
#define BITCOINNICKEL_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinnickel node (bitcoinnickeld process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINNICKEL_INTERFACES_NODE_H
