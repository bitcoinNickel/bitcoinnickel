...
#ifndef BITCOINNICKEL_QT_SENDCOINSDIALOG_H
#define BITCOINNICKEL_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinnickels */
...
#endif // BITCOINNICKEL_QT_SENDCOINSDIALOG_H
