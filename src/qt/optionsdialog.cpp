    ...
    mapper(0)
{
    ...
    ui->bitcoinnickelAtStartup->setToolTip(ui->bitcoinnickelAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinnickelAtStartup->setText(ui->bitcoinnickelAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinNickelConfButton->setToolTip(ui->openBitcoinNickelConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinNickelUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinnickelAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinNickelConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinNickelConf())
