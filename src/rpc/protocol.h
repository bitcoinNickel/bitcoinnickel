...
// Copyright (c) 2009-2021 The Bitcoinnickel Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINNICKEL_RPC_PROTOCOL_H
#define BITCOINNICKEL_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinnickeld
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bitcoinnickel is not connected
...
#endif // BITCOINNICKEL_RPC_PROTOCOL_H
