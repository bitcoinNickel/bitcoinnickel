...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinnickelcore.org", "www.bitcoinnickelcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinnickelcore.org]", "www.bitcoinnickelcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinnickelcore.org:80", "www.bitcoinnickelcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinnickelcore.org]:80", "www.bitcoinnickelcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:24744", "127.0.0.1", 24744));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:24744", "127.0.0.1", 24744));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:24744", "::ffff:127.0.0.1", 24744));
    BOOST_CHECK(TestSplitHost("[::]:24744", "::", 24744));
    BOOST_CHECK(TestSplitHost("::24744", "::24744", -1));
    BOOST_CHECK(TestSplitHost(":24744", "", 24744));
    BOOST_CHECK(TestSplitHost("[]:24744", "", 24744));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:24744", "127.0.0.1:24744"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:24744", "[::]:24744"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
