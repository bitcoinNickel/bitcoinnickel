...
#ifndef BITCOINNICKEL_TEST_SCRIPTNUM10_H
#define BITCOINNICKEL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinNickel Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINNICKEL_TEST_BIGNUM_H
