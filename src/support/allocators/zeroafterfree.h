...
#ifndef BITCOINNICKEL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINNICKEL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINNICKEL_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
