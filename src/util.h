 ...
 */
#ifndef BITCOINNICKEL_UTIL_H
#define BITCOINNICKEL_UTIL_H
...
extern const char * const BITCOINNICKEL_CONF_FILENAME;
extern const char * const BITCOINNICKEL_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinnickel-%s", name);
