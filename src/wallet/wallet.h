...
#ifndef BITCOINNICKEL_WALLET_WALLET_H
#define BITCOINNICKEL_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinnickel node, and set to 0 for transactions that were created
...
#endif // BITCOINNICKEL_WALLET_WALLET_H
