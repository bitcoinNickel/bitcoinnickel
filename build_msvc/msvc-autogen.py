...
# Copyright (c) 2016-2022 The Bitcoinnickel Core developers
...
def main():
    parser = argparse.ArgumentParser(description='Bitcoinnickel-core msbuild configuration initialiser.')
