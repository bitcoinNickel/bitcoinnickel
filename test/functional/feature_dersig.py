...
class BIP66Test(BitcoinNickelTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinnickeld is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinnickeld produces more specific reject
            # reasons.
