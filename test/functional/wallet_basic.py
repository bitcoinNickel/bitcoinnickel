...
class WalletTest(BitcoinNickelTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BCON from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 bcon in block rewards plus fees, but
        ...
        # Send 10 BCON with subtract fee from amount
        ...
        # Sendmany 10 BCON with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitcoinnickel/bitcoinnickel/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
