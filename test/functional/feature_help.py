...
"""Verify that starting bitcoinnickel with -h works as expected."""

from test_framework.test_framework import BitcoinNickelTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinNickelTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinnickel with -h for help text")
        ...
        self.log.info("Start bitcoinnickel with -version for version information")
        ...
        self.log.info("Start bitcoinnickeld with -fakearg to make sure it does not start")
