...
# TestP2PConn: A peer we use to send messages to bitcoinnickeld, and store responses.
...
class CompactBlocksTest(BitcoinNickelTestFramework):
    ...
    # This test actually causes bitcoinnickeld to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinnickeld's choice of nonce.
    ...
    # Test that bitcoinnickeld requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinnickeld to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinnickeld will not send blocktxn responses for blocks whose height is
