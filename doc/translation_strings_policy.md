...
This document provides guidelines for internationalization of the BitcoinNickel Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinnickel_en.ts` remains unchanged.
